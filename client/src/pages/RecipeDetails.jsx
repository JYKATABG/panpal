...
const RecipeDetails = () => {
    ...
    const handleCreateComment = async (e) => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:5500/api/v1/recipes/${recipeId}/comments`,
                {
                    text: commentText,
                }
            );
    ...
    const handleLike = async (commentId, ownerId) => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:5500/api/v1/recipes/${recipeId}/comments/${commentId}/like`
            );
    ...
    const handleDeleteComment = async (commentId) => {
        try {
            const response = await axios.delete(
                `http://localhost:5500/api/v1/recipes/${recipeId}/comments/${commentId}`
            );
        ...
        <div className="min-h-screen bg-gradient-to-r from-sky-100 to-indigo-100 p-6">
            ...
            >
                <motion.div
                    ...
                    className="flex items-center justify-between gap-4 p-4 bg-indigo-50 rounded-xl shadow-sm"
                >
            ...
            <div className="max-w-4xl mx-auto mt-10 space-y-6">
                ...
                <h1 className="font-bold text-xl">Comments ({recipeData?.comments?.length})</h1>
